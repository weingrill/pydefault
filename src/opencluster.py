...
class OpenCluster(object):
    ...
    def __init__(self, objectname='', uname='', ra=None, dec=None, obsmode=None):
        ...
        if obsmode == 'bvs':
            ...
            self.sequence['ExposureIncrease'] = '3*1,3*3'
            self.sequence['FilterSequence'] = '3*V,3*B'
            self.mode['pernight'] = 2 # can be refined

        if obsmode == 'bvl':
            self.sequence['ExposureTime'] = 300.0
            self.sequence['ExposureRepeat'] = 9
            self.sequence['ExposureIncrease'] = '3*1,3*3'
            self.sequence['FilterSequence'] = '3*V,3*B'
            self.mode['pernight'] = 2 # can be refined
        ...
        if obsmode == 'bvsl30':
            self.sequence['ExposureTime'] = 30.0 # 20.0 + 200.0
            self.sequence['ExposureRepeat'] = 20
            self.sequence['ExposureIncrease'] = '5*1,5*3,5*10,5*10'
            self.sequence['FilterSequence'] = '5*V,5*B,5*V,5*B'
            self.mode['pernight'] = 2 # can be refined
        ...
        if obsmode == 'cmds':
            self.sequence['ExposureTime'] = 30.0
            self.sequence['ExposureRepeat'] = 9
            self.sequence['ExposureIncrease'] = '3*1,3*1.5,3*3'
            self.sequence['FilterSequence'] = '3*I,3*V,3*B'
            self.mode['pernight'] = 2 # can be refined
...
def do_ngc6940():
    ...
    ngc6940 = OpenCluster(objectname='NGC 6940', uname='NGC 6940 rot', obsmode='rot') #1850
    ngc6940.title = 'TBD'
    ngc6940.abstract = 'TBD'
