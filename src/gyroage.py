...
def tau(bv, gilliland = True):
    ...
    B and V from Lejeune et al (1997,1998)
    Global \tau_C (d)
    """
    import numpy as np
    from scipy.interpolate import interp1d
    a = np.array([[15.056, 13.425, 339.8],
                  [14.000, 12.464, 367.9],
                  [13.316, 11.788, 408.6],
                  [12.761, 11.247, 493.0],
                  [12.308, 10.809, 358.4],
    ...
    tau_C = np.array([  0.   ,   0.  ,   0.  ,   0.  ,   0.  ,   2.394,
                        8.141,  14.67,  21.93,  28.64,  34.87,  41.24 ,
                       47.9  ,  55.01,  62.54,  70.89,  81.17,  93.05 ,
                      106.8  , 125.4 , 146.8 , 176.9 , 222.1 , 358.4  ,
                      493.   , 408.6 , 367.9 , 339.8  ])
    BV = np.array([ 0.331, 0.356, 0.388, 0.416, 0.443, 0.473, 0.504, 0.535,
                    0.57 , 0.611, 0.662, 0.724, 0.796, 0.883, 0.985, 1.098,
                    1.197, 1.271, 1.334, 1.385, 1.423, 1.453, 1.475, 1.499,
                    1.514, 1.528, 1.536, 1.631])
